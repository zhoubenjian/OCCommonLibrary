...
@interface TwoColumnWaterFlowLayout ()
/** 存放每列高度字典*/
...
@implementation TwoColumnWaterFlowLayout
...
- (CGSize)collectionViewContentSize {
    ...
    [_dicOfheight enumerateKeysAndObjectsUsingBlock:^(id  _Nonnull key, id  _Nonnull obj, BOOL * _Nonnull stop) {
        if ([self.dicOfheight[maxHeightline] floatValue] < [obj floatValue]) {
            maxHeightline = key;
        }
    }];
